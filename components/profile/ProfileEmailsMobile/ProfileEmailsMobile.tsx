    ...
    <div className=' w-full min-h-[10.75rem] items-center flex-col relative justify-start flex'>
      ...
      <div className='z-10 block w-full p-8 '>
        <div className='border-b border-profile-border max-w-[27rem] pb-6 mx-auto'>
          <h1 className='text-white leading-9.5 text-sm uppercase'>
        ...
        {emails.length > 1 ? (
          <h1 className='text-white leading-9.5 text-sm max-w-[27rem] uppercase mt-[3.75rem] mb-6 mx-auto '>
          ...
          emails.map(
            (email) =>
              !email.is_primary && (
                ...
                >
                  <h1 className='text-white leading-9.5 text-xl'>
                    {email.email}
                  </h1>
                  <div className='flex justify-between items-center mt-6'>
                    {email.email_verified_at ? (
                      <h1
                        ...
                        className=' p-1 border border-zinc-350 rounded-md w-40 text-center text-white text-base leading-9.5 cursor-pointer'
                      >
                        {t('user.profile.makePrimary')}
                      </h1>
                    ) : (
                      <h1 className='italic text-amber-550 text-base leading-9.5 flex justify-center gap-2 items-center'>
                        <NotVerified />
                        {t('user.profile.notVerified')}
                      </h1>
                    )}
                    <h1
                      className='text-gray-350 text-base leading-9.5 cursor-pointer'
        ...
        {google_id === null && (
          <div className='max-w-[27rem] mx-auto mt-[3.75rem]'>
            <h1 className='text-white leading-9.5 text-sm  uppercase  mb-6 '>
