...
const LandingTop: React.FC<LandingTopProps> = ({ setWhichForm }) => {
  ...
  return (
    <div className='h-[50.5rem] bg-landing-gradient relative overflow-x-hidden'>
      ...
      <div className='md:gap-6 gap-8 flex flex-col justify-center top-1/2 translate-y-[-50%] items-center z-10 absolute w-full'>
        ...
        <button
          ...
          className='bg-red-650 hover:bg-red-750 text-white text-base lg:text-xl leading-[150%] py-2 lg:py-2.5 px-7 lg:px-4 rounded-md '
        >
