    ...
    <Fragment>
      <div className='h-screen sticky top-0 overflow-x-hidden'>
        ...
        <div className='z-[3] absolute flex gap-4 top-[18rem] md:top-[25.813rem] left-[2.188rem] md:left-[10.625rem]'>
          ...
          <div>
            <h1 className='font-bold max-w-[47.563rem] text-white leading-9.5 md:leading-9.5 text-xl md:text-5xl'>
              {t('landing.interstellar.text')}
            </h1>
            <h1 className='font-bold text-zinc-350 leading-9.5 text-base md:text-3xl  mt-4'>
